...
func (x *LoginWithEmailAndPasswordRequest) Reset() {
	*x = LoginWithEmailAndPasswordRequest{}
...
func (x *LoginWithEmailAndPasswordRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginWithEmailAndPasswordRequest) ProtoMessage() {}

func (x *LoginWithEmailAndPasswordRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_auth_service_proto_msgTypes[0]
...
// Deprecated: Use LoginWithEmailAndPasswordRequest.ProtoReflect.Descriptor instead.
func (*LoginWithEmailAndPasswordRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_auth_service_proto_rawDescGZIP(), []int{0}
}

func (x *LoginWithEmailAndPasswordRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *LoginWithEmailAndPasswordRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_api_proto_auth_service_proto_rawDesc = []byte{
	...
	0x61, 0x75, 0x74, 0x68, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x54, 0x0a, 0x20,
	0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x57, 0x69, 0x74, 0x68, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x41, 0x6e,
	...
	0x0c, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x79, 0x0a,
	0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x6a, 0x0a, 0x19,
	0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x57, 0x69, 0x74, 0x68, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x41, 0x6e,
	0x64, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x2e, 0x2e, 0x61, 0x75, 0x74, 0x68,
	0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x57, 0x69,
	0x74, 0x68, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x41, 0x6e, 0x64, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f,
	...
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6e, 0x61, 0x6e, 0x64, 0x61, 0x6e, 0x75, 0x72, 0x73,
	0x65, 0x70, 0x74, 0x61, 0x6d, 0x61, 0x2f, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2d, 0x6d, 0x69,
	0x63, 0x72, 0x6f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x61, 0x75, 0x74, 0x68,
	0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f,
...
var file_api_proto_auth_service_proto_goTypes = []interface{}{
	(*LoginWithEmailAndPasswordRequest)(nil), // 0: auth_service.LoginWithEmailAndPasswordRequest
	(*LoginResponse)(nil),                    // 1: auth_service.LoginResponse
}
var file_api_proto_auth_service_proto_depIdxs = []int32{
	0, // 0: auth_service.AuthService.LoginWithEmailAndPassword:input_type -> auth_service.LoginWithEmailAndPasswordRequest
	1, // 1: auth_service.AuthService.LoginWithEmailAndPassword:output_type -> auth_service.LoginResponse
...
func file_api_proto_auth_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_proto_auth_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoginWithEmailAndPasswordRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
